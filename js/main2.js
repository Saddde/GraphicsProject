	...
	var mus = {
		...
		*/
		...
		boot: function() {
			...
			mus.scene.fog = new THREE.FogExp2(0x666666, 0.025);
		...
		create: function() {
			...
			mus.wall1 = new THREE.Mesh(new THREE.BoxGeometry(40,6, 0.001), new THREE.MeshLambertMaterial({color: 0xffffff}));
			mus.wall2 = new THREE.Mesh(new THREE.BoxGeometry(6,6, 0.001), new THREE.MeshLambertMaterial({color: 0xffffff}));
			mus.wall3 = new THREE.Mesh(new THREE.BoxGeometry(6,6, 0.001), new THREE.MeshLambertMaterial({color: 0xffffff}));
			mus.wall4 = new THREE.Mesh(new THREE.BoxGeometry(40,6, 0.001), new THREE.MeshLambertMaterial({color: 0xffffff}));

			mus.wallGroup.add(mus.wall1, mus.wall2, mus.wall3, mus.wall4);
			mus.wallGroup.position.y = 3;

			mus.wall1.position.z = -3;
			mus.wall2.position.x = -20;
			mus.wall2.rotation.y = Math.PI/2;
			mus.wall3.position.x = 20;
			mus.wall3.rotation.y = -Math.PI/2;
			mus.wall4.position.z = 3;
			...
			mus.ceilMaterial = new THREE.MeshLambertMaterial({color: 0xeeeeee});
